...
import nl.oikos.raytracter.brdf.SpatialVaryingLambertian;
 ...
 */
public class SpatialVaryingMatte extends Material
{

	private SpatialVaryingLambertian ambientBRDF;
	private SpatialVaryingLambertian diffuseBRDF;

	public SpatialVaryingMatte()
	{
		super();
		this.ambientBRDF = new SpatialVaryingLambertian();
		this.diffuseBRDF = new SpatialVaryingLambertian();
	}
